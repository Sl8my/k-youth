                ...
                <div className="row">
                  <div className="col-lg-3 col-md-6 col-sm-5 order-1">
                    <div className="footer-widget mt-0">
                      <h5 className="footer-widget-title"></h5>
                    </div>
                  </div>
                        ...
                        <ul className="link-list">
                          <li className="contact-box">
                            ...
                            <div className="contact-links">
                              <p className="footer-widget-subtitle">
                                info@k-youth.ch
                              </p>
                            </div>
                          </li>
                          <li className="contact-box">
                            ...
                            <div className="contact-links">
                              <p className="footer-widget-subtitle">
                              Kiwanis Club Bellinzona e Valli - c/o Emilio Scossa Baggi <br></br>Via Viale S. Franscini 9, 6512 Giubiasco
                              </p>
                            </div>
                          </li>
                        </ul>
                  ...
                  <div className="col-lg-5  order-3 order-lg-1">
                    <div className="footer-copyright">
                      <p>
                        ...
                        <Link onClick={this.scrollTop} to={`${process.env.PUBLIC_URL}/`}>
                          Domenico Serravalle
                        </Link>
                      </p>
                    </div>
